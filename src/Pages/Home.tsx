...
function Home() {
  const allGames: PortfolioItem[] = [
    {name: "Game Price Drops", skills: ["React", "Node.js", "HTML", "CSS", "JavaScript", "TypeScript", "PostgreSQL", "AWS"], description: "A website that scrapes the latest video game sales data and notifies users of new sales.", link_url: "https://www.gamepricedrops.com", image_url: "project_imgs/GamePriceDrops.webp", repo_url: null},
